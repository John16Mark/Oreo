...
Implementación de la búsqueda de fibonacci con threads en C obtenida en https://www.geeksforgeeks.org/fibonacci-search/
Toma n números enteros de la entrada estándar en la forma:
> FibonacciT N NumThreads a0 a1 a2 a3 ... an (en linux)
...
//Funciones
void Fibonacci(int *A, int inicio, int fin, int k);
