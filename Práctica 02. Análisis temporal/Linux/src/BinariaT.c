...
// gcc BinariaThreads.c -lpthread tiempos/tiempo.c -o BinariaThreads
//Ejemplo de ejecución en la terminal ./BinariaThreads 500000 82182077 8 < orden10millones.txt
...
{	
	...
	busquedaBinaria(A, inicio, fin, k);
