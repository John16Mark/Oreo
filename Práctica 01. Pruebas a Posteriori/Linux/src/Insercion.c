...
Implementación del ordenamiento por inserción en C basada en el pseudocódigo proporcionado por el profesor.
...
Ordena el arreglo A de tamaño n mediante el algoritmo de inserción
Complejidad: O(n^2)
*/
void Insercion(int *A, int n)
{
